...
var REDIRECT_URL = "https://xapi-test.kurtkanaskie.net/oidc-app-facade/oidc-client-code-google-x-facade/callback.html";
...
// App = oidc-facade
var CLIENT_ID = "REwLa7ACGffyaWhW5qOWOvBFzJ3gqGoseK96VoeZU75TMX0b";
var CLIENT_SECRET = "QDh0zUsOIwmeDZscVARAWe2WZp0bDhAb1lXZzOjgamGXxK2CVeNPGpAGrBOaGADO";
...
app.controller("HomeController", function($scope, $http, $state, $window) {
    ...
    $scope.login = function() {
      ...
      var authorize = OIDC_BASEPATH + "/authorize" 
          ...
          + "&response_type=code"
          + "&state=PA-code"
          + "&scope=email profile openid fix-scope-with-url";
